package aoss.assignment.a2.leaftech.inventory;
...
//                Class.forName( "com.mysql.jdbc.Driver" );
                ...
                //define the data source
                String SQLServerIP = jTextField1.getText();
                String sourceURL = "jdbc:mysql://" + SQLServerIP + ":3306/leaftech?serverTimezone=UTC";

                msgString = ">> Establishing connection with: " + sourceURL + "...";
                jTextArea1.append("\n"+msgString);

                //create a connection to the db
                DBConn = DriverManager.getConnection(sourceURL,"root","adminadmin");
...
//                    Class.forName( "com.mysql.jdbc.Driver" );
                    ...
                    //create a connection to the db
                    DBConn = DriverManager.getConnection(sourceURL,"","adminadmin");
