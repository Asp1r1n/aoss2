...
CREATE TABLE `authlogs` (
  ...
  PRIMARY KEY (`id`),
  KEY `authlogs_users_id_fk` (`user_id`),
  CONSTRAINT `authlogs_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2020-04-14  0:48:45
